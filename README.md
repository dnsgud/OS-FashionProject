...
본 프로젝트는 기온 및 날씨 환경에 맞추어 최적의 개인 코디네이트를 제안하는 AI 기반 스마트 기후 패션 시스템이다.
...
python -m coverage run --source=myproject,myproject_test -m pytest
...
1. **[gichan8420] (권기찬)** -  ai 사진분석 알고리즘 및 프로필, 회원가입 로직 담당
